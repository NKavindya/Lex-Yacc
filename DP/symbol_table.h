...
typedef struct Symbol {
    char *name;
    char *typeName;   /* e.g., \"integer\", \"float\", or class name */
    SymKind kind;
    int lineno;
    int size;         /* bytes reserved (for data-bearing symbols) */
    int offset;       /* stack-frame offset (negative for locals, positive for params) */
    struct Symbol *next;
...
typedef struct SymTable {
    ...
    struct SymTable *next;  /* next scope in global list */
