...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_stmt_list = 23,                 /* stmt_list  */
...
{
       0,   244,   244,   249,   255,   260,   263,   266,   269,   276,
...
static const char *const yytname[] =
{
  ...
  "WHILE", "IF", "THEN", "ELSE", "PRINT", "ASSIGN", "GT", "LT", "EQ",
  "PLUS", "MINUS", "SEMI", "LBRACE", "RBRACE", "'('", "')'", "$accept",
  "program", "stmt_list", "stmt", "condition", "expr", YY_NULLPTR
};
...
{
       4,    -9,   -16,     3,    18,    27,     4,   -17,    11,     3,
       7,    21,    15,   -17,   -17,   -17,   -17,     8,    12,    30,
      31,    32,     4,   -17,    11,    11,   -17,    19,   -17,   -17,
     -17,    29,    -3,    -3,     4,     4,    -1,   -17,   -17
};
...
{
       0,     0,     0,     0,     0,     0,     2,     4,     0,     0,
       0,     0,     0,     1,     3,    13,    12,     0,     0,     0,
       0,     0,     0,     8,     0,     0,     5,     0,     9,    10,
      11,     0,    14,    15,     0,     0,     0,     7,     6
};
...
{
      14,     8,     1,     9,     2,     3,    10,     1,     4,     2,
       3,    24,    25,     4,    15,    16,    31,    38,    19,    20,
      21,    12,    24,    25,    26,    32,    33,    13,    22,    37,
      14,    23,    27,    28,    29,    30,    34,    35,     0,    36,
       0,     0,    18
};

static const yytype_int8 yycheck[] =
{
       6,    10,     3,    19,     5,     6,     3,     3,     9,     5,
       6,    14,    15,     9,     3,     4,    22,    18,    11,    12,
      13,     3,    14,    15,    16,    24,    25,     0,     7,    35,
      36,    16,    20,     3,     3,     3,    17,     8,    -1,    34,
      -1,    -1,     9
};
...
{
       0,     3,     5,     6,     9,    22,    23,    24,    10,    19,
       3,    25,     3,     0,    24,     3,     4,    26,    25,    11,
      12,    13,     7,    16,    14,    15,    16,    20,     3,     3,
       3,    24,    26,    26,    17,     8,    23,    24,    18
};
...
#line 244 "q1.y"
              { execute_stmt_list((yyvsp[0].stmt_ptr)); }
#line 1311 "q1.tab.c"
    break;
...
#line 249 "q1.y"
                     {
          struct stmt_node *temp = (yyvsp[-1].stmt_ptr);
          while (temp->next) temp = temp->next;
          temp->next = (yyvsp[0].stmt_ptr);
          (yyval.stmt_ptr) = (yyvsp[-1].stmt_ptr);
      }
#line 1322 "q1.tab.c"
    break;
...
#line 1328 "q1.tab.c"
  ...
  case 5: /* stmt: IDENTIFIER ASSIGN expr SEMI  */
#line 260 "q1.y"
                                  {
          (yyval.stmt_ptr) = create_assign_stmt_node((yyvsp[-3].sval), (yyvsp[-1].expr_ptr));
      }
#line 1336 "q1.tab.c"
    break;

  case 6: /* stmt: WHILE '(' condition ')' LBRACE stmt_list RBRACE  */
#line 263 "q1.y"
                                                      {
          (yyval.stmt_ptr) = create_while_stmt_node((yyvsp[-4].cond_ptr), (yyvsp[-1].stmt_ptr));
      }
#line 1344 "q1.tab.c"
    break;

  case 7: /* stmt: IF condition THEN stmt ELSE stmt  */
#line 266 "q1.y"
                                       {
          (yyval.stmt_ptr) = create_if_stmt_node((yyvsp[-4].cond_ptr), (yyvsp[-2].stmt_ptr), (yyvsp[0].stmt_ptr));
      }
#line 1352 "q1.tab.c"
    break;

  case 8: /* stmt: PRINT IDENTIFIER SEMI  */
#line 269 "q1.y"
                            {
          (yyval.stmt_ptr) = create_print_stmt_node((yyvsp[-1].sval));
      }
#line 1360 "q1.tab.c"
    break;

  case 9: /* condition: IDENTIFIER GT IDENTIFIER  */
#line 276 "q1.y"
                               { (yyval.cond_ptr) = create_condition(COND_GT, (yyvsp[-2].sval), (yyvsp[0].sval)); }
#line 1366 "q1.tab.c"
    break;

  case 10: /* condition: IDENTIFIER LT IDENTIFIER  */
#line 277 "q1.y"
                               { (yyval.cond_ptr) = create_condition(COND_LT, (yyvsp[-2].sval), (yyvsp[0].sval)); }
#line 1372 "q1.tab.c"
    break;

  case 11: /* condition: IDENTIFIER EQ IDENTIFIER  */
#line 278 "q1.y"
                               { (yyval.cond_ptr) = create_condition(COND_EQ, (yyvsp[-2].sval), (yyvsp[0].sval)); }
#line 1378 "q1.tab.c"
    break;

  case 12: /* expr: NUMBER  */
#line 283 "q1.y"
             { (yyval.expr_ptr) = create_num_expr((yyvsp[0].ival)); }
#line 1384 "q1.tab.c"
    break;

  case 13: /* expr: IDENTIFIER  */
#line 284 "q1.y"
                 { (yyval.expr_ptr) = create_id_expr((yyvsp[0].sval)); }
#line 1390 "q1.tab.c"
    break;

  case 14: /* expr: expr PLUS expr  */
#line 285 "q1.y"
                     { (yyval.expr_ptr) = create_bin_expr(EXPR_PLUS, (yyvsp[-2].expr_ptr), (yyvsp[0].expr_ptr)); }
#line 1396 "q1.tab.c"
    break;

  case 15: /* expr: expr MINUS expr  */
#line 286 "q1.y"
                      { (yyval.expr_ptr) = create_bin_expr(EXPR_MINUS, (yyvsp[-2].expr_ptr), (yyvsp[0].expr_ptr)); }
#line 1402 "q1.tab.c"
    break;
