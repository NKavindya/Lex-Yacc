...
/* Expect 3 shift/reduce conflicts due to nested access patterns in LALR(1) parser */
/* These conflicts are resolved correctly by Bison's default shift action */
/* The conflicts arise from expressions like "x.y.z" and array indexing "a[i][j]" */
%expect 3
